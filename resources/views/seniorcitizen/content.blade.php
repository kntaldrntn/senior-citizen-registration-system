            ...
            @forelse ($seniorcitizens as $citizen)
                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @else
                            <div class="h-12 w-12 rounded-full bg-gray-100 flex items-center justify-center text-gray-400" title="No photo">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="text-sm text-gray-500">{{ $citizen->contact_number }}</div>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-700 max-w-xs truncate" title="{{ $citizen->address }}">
                        {{ $citizen->address }}
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <button @click="openViewModal({{ $citizen->id }})" class="text-gray-500 hover:text-gray-700 p-1" title="View">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="mt-3 text-lg font-medium text-gray-900">No senior citizens found.</p>
